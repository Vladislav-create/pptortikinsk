...
app.post('/api/bricks', function (req, res) {
    const user = [req.body.id, 'Ivan', 'Popov', '89961235698', 'werwqrqwr@mail.ru']
    const sql = 'INSERT INTO pptortikinsk.users (idusers, userFirstName, userLastName, userPhone, userEmale) VALUES (?, ?, ?, ?, ?)'
